...
namespace Cursach.КОД
{
    class ViewDepartmentVM : BaseVM
    {
        ...
        public int SelectedIndex
        {
            ...
            {
                selectedIndex = value;
                Departments = SqlModel.GetInstance().SelectDepartmentsRange((selectedIndex - 1) * ViewRowsCount, ViewRowsCount);
                Signal();
            }
        }
